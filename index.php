...
<html lang="en">
	<head>
		...
		<meta name="description" content="Week 06 - Lab 06">
...
<!-- STEP 2b: How does the hyperlink text appear differently than the rest of the page? A: He is underlined and blue.
Click on the link, then click on the 'Back' button on your browser - how does the same link appear now? A: In another color, purple. Showing the button was pushed at least one time -->
<!-- STEP 2c: Look at your browsing history for this particular link - then clear your history and reload the page - notice how the link is restored - this is wayfinding - OK -->
				</figure>
				<h3>Did You Know…?</h3>
